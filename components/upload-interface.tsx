          ...
          {[
            {
              ...
              description: "Extract transaction data from file",
              status:
                status === "complete"
                  ? "complete"
            ...
            },
            {
              ...
              description: "Categorize transactions using OpenAI",
              status:
                status === "complete"
                  ? "complete"
            ...
            },
            {
              ...
              description: "Identify and extract vendor information",
              status:
                status === "complete"
                  ? "complete"
            ...
            },
            {
              ...
              description: "Data ready for comprehensive analysis",
